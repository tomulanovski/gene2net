#!/usr/bin/env python3
"""
Process species trees: convert topology to ultrametric tree of height 1M.
Usage: python rescale_and_ultrametric.py <base_dir> [--seed SEED]
"""
...
def process_all_trees(base_dir, seed=None):
    ...
    for network in networks:
        ...
        # Convert topology to ultrametric tree with height 1,000,000
        # This is the KEY function that guarantees exact ultrametricity
        tree = make_ultrametric_from_topology(tree, target_height=1000000)
        print(f"  Converted to ultrametric (height=1,000,000)")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python rescale_and_ultrametric.py /path/to/sims
  python rescale_and_ultrametric.py /path/to/sims --seed 42
        """
    )
    parser.add_argument('base_dir', 
                       help='Base directory containing network subdirectories')
    ...
    process_all_trees(args.base_dir, seed=args.seed)
