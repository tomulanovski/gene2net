...
#SBATCH --array=1-21
#SBATCH --output=/groups/itay_mayrose/tomulanovski/gene2net/simulations/logs/simphy_height_50_million_trees_100000_ne_high_dup_job_%a.out
#SBATCH --error=/groups/itay_mayrose/tomulanovski/gene2net/simulations/logs/simphy_height_50_million_trees_100000_ne_high_dup_job_%a.err
#SBATCH --time=1:00:00
#SBATCH --mem=32g
...
OUTPUT_DIR="${BASE_DIR}/${network}/data/high_dup_ne_100000_height_50_million_trees"
