...
#SBATCH --array=0-20
#SBATCH --output=/groups/itay_mayrose/tomulanovski/gene2net/simulations/logs/notung_simulated_1_mil_high_%a.out
#SBATCH --error=/groups/itay_mayrose/tomulanovski/gene2net/simulations/logs/notung_simulated_1_mil_high_%a.err
...
GENE_TREES_DIR="${BASE_DIR}/${NETWORK}/data/high_dup_ne_100000_height_1_million_trees/1"
GENE_TREES_NHX_DIR="${BASE_DIR}/${NETWORK}/data/high_dup_ne_100000_height_1_million_trees/gene_trees_nhx"
SPECIES_TREE_NEWICK="${BASE_DIR}/${NETWORK}/species_tree_1_million.tre"
OUTPUT_DIR="${BASE_DIR}/${NETWORK}/data/high_dup_ne_100000_height_1_million_trees/reconciled_for_dup"
