...
#SBATCH --array=1-21
#SBATCH --output=/groups/itay_mayrose/tomulanovski/gene2net/simulations/logs/padre_process_ILS_low_dup_low_job_%a.out
#SBATCH --error=/groups/itay_mayrose/tomulanovski/gene2net/simulations/logs/padre_process_ILS_low_dup_low_job_%a.err
#SBATCH --time=2:00:00
#SBATCH --mem=2g
...
OUTPUT_DIR="${BASE_DIR}/${network}/processed/ILS_low_dup_low/padre_input"
