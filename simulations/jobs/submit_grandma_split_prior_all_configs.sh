...
# ============================================================================
# SUBMIT_GRANDMA_SPLIT_PRIOR_ALL_CONFIGS.SH
# ============================================================================
# Submits run_grandma_split_prior.sh for all 9 configurations.
# Each submission is a SLURM array of 105 jobs (21 networks × 5 replicates).
# The ploidy prior is derived automatically from each replicate's Polyphest
# multiset file (polyphest_input/replicate_N/multi_set.txt).
#
# Usage:
#   ./submit_grandma_split_prior_all_configs.sh [--dry-run]
# ============================================================================

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
RUN_SCRIPT="${SCRIPT_DIR}/run_grandma_split_prior.sh"
...
echo "Submitting grandma_split_prior for ${#CONFIGS[@]} configurations..."
echo ""
