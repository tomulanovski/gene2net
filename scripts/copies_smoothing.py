...
python "/groups/itay_mayrose/tomulanovski/gene2net/scripts/copies_smoothing.py" -i input_trees.tre -o output.tsv
"""
...
def main():
    ...
    print(f"Total species analyzed: {len(representative_copies)}")
