#!/bin/bash
#SBATCH --job-name=grampa_analysis
...
GENE_TREES="/groups/itay_mayrose/tomulanovski/gene2net/papers/Wu_2015/rooted_trees/grampa_trees.tre"
SPECIES_TREE="/groups/itay_mayrose/tomulanovski/gene2net/papers/Wu_2015/gene_trees/astral_4.tre"
OUTPUT_DIR="/groups/itay_mayrose/tomulanovski/gene2net/papers/Wu_2015/networks/grampa/analysis/"
