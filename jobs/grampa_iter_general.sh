...
GENE_TREES="/groups/itay_mayrose/tomulanovski/gene2net/papers/Ren_2024/gene_trees/grampa_trees_updated.tre"
SPECIES_TREE="/groups/itay_mayrose/tomulanovski/gene2net/papers/Ren_2024/gene_trees/astral.tre"
OUTPUT_DIR="/groups/itay_mayrose/tomulanovski/gene2net/papers/Ren_2024/networks/grampa/analysis/iter"
...
# Run GRAMPA
python "/groups/itay_mayrose/ronenshtein/gene2network/grampa-main/grampa.py" -g $GENE_TREES -s $SPECIES_TREE -i -1 -o $OUTPUT_DIR --overwrite
