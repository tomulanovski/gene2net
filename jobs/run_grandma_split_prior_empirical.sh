#!/bin/bash
#SBATCH --job-name=grandma_split_prior_empirical
#SBATCH --array=1-12
#SBATCH --output=/groups/itay_mayrose/tomulanovski/gene2net/logs/grandma_split_prior_%a.out
#SBATCH --error=/groups/itay_mayrose/tomulanovski/gene2net/logs/grandma_split_prior_%a.err
...
# ============================================================================
# RUN_GRANDMA_SPLIT_PRIOR_EMPIRICAL.SH
# ============================================================================
# Runs GRANDMA_SPLIT with ploidy prior (-x) on empirical datasets.
...
#
# Usage:
#   sbatch run_grandma_split_prior_empirical.sh
# ============================================================================
...
PLOIDY_FILE="${PAPERS_DIR}/${dataset}/split_ploidies.txt"
OUTPUT_DIR="${PAPERS_DIR}/${dataset}/networks/grandma_split_prior"
...
echo "============================================================================"
echo "RUN GRANDMA_SPLIT WITH PLOIDY PRIOR (EMPIRICAL)"
echo "============================================================================"
...
if [ ! -f "$PLOIDY_FILE" ]; then
    echo "ERROR: Ploidy file not found: $PLOIDY_FILE"
    exit 1
fi
...
if [ $exit_code -eq 0 ]; then
    echo "✓ GRANDMA_SPLIT (PLOIDY PRIOR) COMPLETED SUCCESSFULLY"
    echo ""
    echo "Dataset:  ${dataset}"
    ...
    echo "✗ GRANDMA_SPLIT (PLOIDY PRIOR) FAILED"
    echo ""
    echo "Dataset:    ${dataset}"
