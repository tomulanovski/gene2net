...
#
# USAGE:
#   ./submit_simphy_training.sh N_TREES MUL_TREES_DIR START_INDEX [CONFIG_NAME] [NE] [NUM_GENE_TREES] [NUM_REPLICATES]
#
# ARGUMENTS:
...
#
# EXAMPLES:
#   ./submit_simphy_training.sh 1000 /path/to/mul_trees 0            # indices 0-999
#   ./submit_simphy_training.sh 1000 /path/to/mul_trees 1000         # indices 1000-1999
#   ./submit_simphy_training.sh 200  /path/to/mul_trees 1000         # indices 1000-1199
# ==============================================================================

N_TREES=${1:?Usage: submit_simphy_training.sh N_TREES MUL_TREES_DIR START_INDEX [CONFIG_NAME] [NE] [NUM_GENE_TREES] [NUM_REPLICATES]}
MUL_TREES_DIR=${2:?Usage: submit_simphy_training.sh N_TREES MUL_TREES_DIR START_INDEX [CONFIG_NAME] [NE] [NUM_GENE_TREES] [NUM_REPLICATES]}
START_INDEX=${3:-0}
...
sbatch \
    ...
    --qos=owner \
    --export=ALL,MUL_TREES_DIR="${MUL_TREES_DIR}",CONFIG_NAME="${CONFIG_NAME}",NE_VAL="${NE_VAL}",NUM_GENE_TREES="${NUM_GENE_TREES}",NUM_REPLICATES="${NUM_REPLICATES}",INDEX_OFFSET="${START_INDEX}" \
